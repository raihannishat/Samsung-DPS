...
using Samsung.Placing;
using Samsung.Placing.Contexts;
using Samsung.Web.Data;
using System;
...
namespace Samsung.Web
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder container)
        {
            ...
            container.RegisterModule(new PlacingModule(connection.connectionString,
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PlacingDbContext>(options =>
                options.UseSqlServer(connection.connectionString, 
